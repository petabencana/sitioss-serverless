...
const config = {
    ...
    AUTH0_ISSUER:
        process.env.AUTH0_ISSUER || 'https://petabencana.au.auth0.com',
    ...
    VOLCANO_REPORTS_TIME_WINDOW:
        process.env.VOLCANO_REPORTS_TIME_WINDOW || 43200, // 12 hr
    ...
    API_FLOODGAUGE_REPORTS_TIME_WINDOW:
        process.env.API_FLOODGAUGE_REPORTS_TIME_WINDOW || 43200,
    ...
    TABLE_FLOODGAUGE_REPORTS:
        process.env.TABLE_FLOODGAUGE_REPORTS || 'floodgauge.reports',
    TABLE_EARTHQUAKE_REPORTS:
        process.env.TABLE_EARTHQUAKE_REPORTS || 'public.earthquakes_reports',
    TABLE_VOLCANO_LIST_REPORTS:
        process.env.TABLE_VOLCANO_LIST_REPORTS || 'volcano.list_volcano',
    TABLE_VOLCANO_LAST_ERUPTION_REPORTS:
        process.env.TABLE_VOLCANO_LAST_ERUPTION_REPORTS ||
        'volcano.lastest_eruption',
    TABLE_SUBSCRIPTIONS:
        process.env.TABLE_SUBSCRIPTIONS || 'subscriptions.subscriptions_table',
    TABLE_SUBSCRIPTIONS_REGIONS:
        process.env.TABLE_SUBSCRIPTIONS_REGIONS ||
        'subscriptions.region_details',
    TABLE_SUBSCRIPTIONS_LOG:
        process.env.TABLE_SUBSCRIPTIONS_LOG || 'subscriptions.log',
    TABLE_REGIONS: process.env.TABLE_REGIONS || 'cognicity.local_cities',
    TABLE_LOGISTICS_NEEDS:
        process.env.TABLE_LOGISTICS_NEEDS || 'logistics.need_reports',
    TABLE_LOGISTICS_GIVER_DETAILS:
        process.env.TABLE_LOGISTICS_GIVER_DETAILS || 'logistics.giver_details',
}
